...
#define BluetoothState_Pin GPIO_PIN_4
#define BluetoothState_GPIO_Port GPIOA
#define StateLED_Pin GPIO_PIN_6
#define StateLED_GPIO_Port GPIOA
#define IMU406_TX_Pin GPIO_PIN_10
#define IMU406_TX_GPIO_Port GPIOB
#define IMU406_RX_Pin GPIO_PIN_11
#define IMU406_RX_GPIO_Port GPIOB
